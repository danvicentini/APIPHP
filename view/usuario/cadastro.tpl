			...
			<div class="card-panel">
				...
				<div class="row">
					<form class="col s12" method="post" action="">
						...
						<input type="hidden" name="hdnTema" value="{$objFormulario->flagLayout}"/>
						...
						<div class="row">
							<div class="input-field col s12">
								<select name="lstIdioma" id="lstIdioma">
									<option value="0" disabled>{$smarty.const.LNG_LABEL_SELECIONAR_IDIOMA}</option>
							...
							<li>
								...
								<div class="collapsible-body" style="" >
									<div class="input-field col s12">
										...
										<option value="0">{$smarty.const.LNG_LABEL_SELECIONAR_TEMA}</option>
										...
										<label>{$smarty.const.LNG_LABEL_SELECIONAR_TEMA}</label>
									</div>
