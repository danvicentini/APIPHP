...
{include file="includes/header.tpl" title=foo}
 <div class="row">
    <form class="col s12">
      <div class="row">
        <div class="input-field col s6">
          <i class="material-icons prefix">perm_phone_msg</i>
          <input placeholder="Placeholder" id="first_name" type="text" class="validate" length="10">
...
<table class="hoverable striped">
	<thead>
		<tr>
			...
			<th data-field="price">Outra Info</th>
		</tr>
	</thead>
	<tbody>
		<tr>
